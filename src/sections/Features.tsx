            ...
            <div className="container">
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center ">
                    {features.map(feature => (
                        <div key={feature} className="bg-neutral-900 border border-white/10 inline-flex  px-3 md:px-5 py-1.5 md:py-2 rounded-lg gap-3 items-center">
                            <span className="bg-lime-400 text-neutral-950 size-5 rounded-lg inline-flex items-center justify-center text-xl">&#10038;</span>
