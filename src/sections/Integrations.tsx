    ...
    return(
        <section className="py-24 overflow-hidden">
            <div className="container">
                ...
                <p className="text-wite/50 mt-4 text-lg">Layers seamlessly connects with your favorite tool, making it easy to plug into any</p>
                ...
                <div className="flex flex-col gap-4 pb-4">
                    {integrations.map(integration =>(
                        <div key={integration.name} className="bg-neutral-900 border border-white/10 rounded-lg p-6">
